...
namespace Simple
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
      ...
      // Also note that we are using IImageCapture2 to get new functionality
      // added in SnagIt 8.1
      private SNAGITLib.IImageCapture2 SnagImg;

		internal System.Windows.Forms.Label Label1;
		internal System.Windows.Forms.GroupBox GroupBox2;
		internal System.Windows.Forms.Button BtnRegion;
		internal System.Windows.Forms.Button BtnWindow;
		internal System.Windows.Forms.GroupBox GroupBox1;
		internal System.Windows.Forms.CheckBox ChkPreviewWindow;
		internal System.Windows.Forms.CheckBox ChkIncludeCursor;
		private System.Windows.Forms.CheckBox chkKeepLinks;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.chkKeepLinks = new System.Windows.Forms.CheckBox();
			...
			// chkKeepLinks
			// 
			this.chkKeepLinks.Location = new System.Drawing.Point(16, 72);
			this.chkKeepLinks.Name = "chkKeepLinks";
			this.chkKeepLinks.Size = new System.Drawing.Size(112, 24);
			this.chkKeepLinks.TabIndex = 2;
			this.chkKeepLinks.Text = "Keep Links";
			// 
			// Form1
			// 
      ...
      private void BtnRegion_Click(object sender, System.EventArgs e)
      {
         ...
         /////////////////////////////////////////////////////////////
         /// The following feature are new with SnagIt v8.1
         
         // Include links in capture?
         if( chkKeepLinks.Checked )
         {
            SnagImg.HotspotType = SNAGITLib.snagHotspotType.shtLinksOnly;
            // Pick an appropriate file type by default:
